...
<img src="Docs/img/title.png" alt="Slime Ranch 타이틀" width="640">
...
<img src="Docs/img/hub.png" alt="목장 화면" width="420"> <img src="Docs/img/dive.png" alt="숲에서 슬라임을 만난 장면" width="420">
...
<img src="Docs/img/biome.png" alt="숲 지도 전체 모습" width="720">
...
| 🌿 초원 | 🪵 늪지대 | 🌋 잿벌 |
|:---:|:---:|:---:|
| <img src="Docs/img/dive.png" width="260"> | <img src="Docs/img/marsh_dive.png" width="260"> | <img src="Docs/img/ashfall_dive.png" width="260"> |
| 밝고 넓은 풀밭 | 어둡고 축축한 진흙탕 | 뜨겁고 새까만 화산재 |
| **파란 슬라임 · 방패 슬라임** | **늪 슬라임** | **용암 슬라임** |
| 반짝이 색 규칙 없음 | 반짝이 = **초록** | 반짝이 = **빨강** |
| <img src="Docs/img/biome.png" width="260"> | <img src="Docs/img/marsh.png" width="260"> | <img src="Docs/img/ashfall.png" width="260"> |
...
|:---:|---|---|---|---|
| <img src="Docs/img/species/slime_basic.png" width="72"> | **파란 슬라임** | 모든 숲 | 평범해요. 제일 많이 만나요 | — |
| <img src="Docs/img/species/slime_guard.png" width="72"> | **방패 슬라임** | 초원 | 아주 튼튼하지만 **공격을 못 해요** | 적이 나 대신 이 친구를 노려요 (방패 역할) |
| <img src="Docs/img/species/slime_bog.png" width="72"> | **늪 슬라임** | 늪지대 | 축축한 초록색 | 가까이 온 적을 **느리게** 만들어요 |
| <img src="Docs/img/species/slime_lava.png" width="72"> | **용암 슬라임** | 잿벌(화산재) | 모든 능력이 조금씩 높아요 | 가까이 온 적을 **계속 태워요** |
| <img src="Docs/img/species/slime_rainbow.png" width="72"> | **무지개 슬라임** | **잡을 수 없어요! 오직 교배로만** (약 5%) | 능력은 조금 낮아요 | 주변을 **치료해요** — 단, 적도 같이 나아요 😅 |

<div align="center">
<img src="Docs/img/species/player.png" width="60"><br>
...
<img src="Docs/img/ui_hud.png" alt="화면 오른쪽 위 확률 표시" width="360">

<sub>`초원 · Corruption T0 · Mutant 5% · Shiny 1.25%` — 그리고 "50마리 더 잡으면 돌연변이 확정"까지 알려줘요</sub>
...
<div align="center">
<img src="Docs/img/species/slime_lava.png" width="96"><br>
...
|:---:|:---:|
| <img src="Docs/img/ui_inventory.png" width="420"> | <img src="Docs/img/ui_breeding.png" width="420"> |
| 잡은 슬라임이 칸칸이 놓여요. 마우스를 올리면 그 아이의 능력이 쪽지로 떠요 | 부모 둘을 고르고 **Breed** 를 누르면 알이 나와요 |

| `J` — 도감 | |
|:---:|:---:|
| <img src="Docs/img/ui_bestiary.png" width="420"> | 한 번이라도 만난 슬라임은 여기에 기록돼요.<br>아직 못 만난 아이는 **???** 로 가려져 있어요.<br>맨 위에 `5종 중 몇 종`, `반짝이 몇 마리` 가 나와요 |
